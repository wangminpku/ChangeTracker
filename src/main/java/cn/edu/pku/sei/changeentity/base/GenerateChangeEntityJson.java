                    ...
                    if(changeEntity instanceof EnumChangeEntity){
                        ...
                        if (changeEntity.clusteredActionBean.fafather.getTreeSrcOrDst() == ChangeEntityDesc.StageITreeType.SRC_TREE_NODE) {
                            ...
                            if(dstNode == null){
                                ...
                                System.out.println("it's a bug,waiting for solving......" + changeEntity.changeEntityId);
                            }else{
...
//        stageIIIBean.setRange(srcRangeStr + "-" + dstRangeStr);
    ...
    public static JSONArray generateEntityJson(MiningActionData miningActionData) {
        ...
        for (int i = 0; i < changeEntityList.size(); i++) {
            ...
            //System.out.println(changeEntity.stageIIBean.getChangeEntity());

            //System.out.println(changeEntity.stageIIIBean.getKey());
            //System.out.println(changeEntity.stageIIIBean.getChangeEntityId());
            //System.out.println(changeEntity.stageIIIBean.getRange());
            //System.out.println(changeEntity.stageIIIBean.getType1());
            //System.out.println(changeEntity.stageIIIBean.getType2());
            //System.out.println(changeEntity.stageIIIBean.getFile());
            //System.out.println(changeEntity.stageIIIBean.getDisplayDesc());
